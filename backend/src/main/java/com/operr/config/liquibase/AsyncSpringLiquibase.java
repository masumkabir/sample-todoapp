package com.operr.config.liquibase;

import com.operr.config.ApplicationConstants;
...
import static com.operr.config.ApplicationConstants.SPRING_PROFILE_DEVELOPMENT;
import static com.operr.config.ApplicationConstants.SPRING_PROFILE_HEROKU;
