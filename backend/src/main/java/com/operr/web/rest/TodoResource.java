...
import com.operr.web.rest.errors.BadRequestAlertException;
import com.operr.web.rest.util.HeaderUtil;
import com.operr.web.rest.util.PaginationUtil;
import com.operr.web.rest.util.ResponseUtil;
...
/**
 * REST controller for managing {@link com.operr.domain.Todo}.
 */
@RestController
...
public class TodoResource {
    ...
    private static final String ENTITY_NAME = "todoappTodo";
     ...
     */
    @GetMapping("/todos")
    public ResponseEntity<List<TodoDTO>> getAllTodos(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
